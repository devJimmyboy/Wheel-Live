...
//       winwheelToDrawDuringAnimation = this
//       wheelAlreadyDrawn = false
//       for (let y = 1; y <= this.numSegments; y++) {
//         if (this.segments[y].image !== null) {
//           this.segments[y].imgData = new Image()
//           this.segments[y].imgData.onload = wheelLoadedImage
...
//     this.endAngle = 0
//   }
//   changeImage(img, imageDirection) {
...
//     this.imgData.onload = wheelLoadedImage
...
// // ====================================================================================================================
// let wheelAlreadyDrawn = false
// function wheelLoadedImage() {
//   // Prevent multiple drawings of the wheel which ocurrs without this check due to timing of function calls.
//   if (wheelAlreadyDrawn == false) {
//     // Set to 0.
